...
import { AddOrUpdateInventorysPage } from './add-or-update-page';
...
describe('DashboardPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [AddOrUpdateInventorysPage],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddOrUpdateInventorysPage);
