...
import { AddOrUpdateNotificationsPage } from './add-or-update-page';
...
describe('DashboardPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [AddOrUpdateNotificationsPage],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddOrUpdateNotificationsPage);
