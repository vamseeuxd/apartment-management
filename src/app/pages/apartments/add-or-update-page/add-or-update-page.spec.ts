...
import { AddOrUpdateApartmentsPage } from './add-or-update-page'
...
describe('DashboardPage', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [AddOrUpdateApartmentsPage],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AddOrUpdateApartmentsPage)
